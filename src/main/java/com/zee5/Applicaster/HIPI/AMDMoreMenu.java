...
public class AMDMoreMenu {
	...
	public static By objLogout = By.xpath("//*[@text='Log out'] | //*[contains(@text,'Log')]");
	public static By objLogoutBtn = By.xpath("//*[@id='logoutButton'] | //*[contains(@text,'Log')]");
...
//	public static By objPrivacyPolicyHeader = By.xpath("//*[@text='Privacy Policy']");
	...
	public static By objshareOptions = By.xpath(
			"//*[@resource-id='android:id/tw_resolver_pagemode_page_list' or @id='resolver_slide'] | //*[@id='resolver_grid'] | //*[@id='title' and contains(text(),'Share')] | //*[@resource-id='android:id/text1']");
